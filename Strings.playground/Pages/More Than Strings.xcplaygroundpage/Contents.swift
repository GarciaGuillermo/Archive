...
let name = " Emanuel "
let number = 200
let adjective = " decent "
let noun = " Camera "
let place = " store "
let positiveEmotion = " excited "
let negativeEmotion = " angry "
let EmanuelsStory = "Today was a big day for \(name). He had finally saved up \(number) dollars and was going to buy a \(adjective) \(noun). He went to the \(noun) \(place) feeling very \(positiveEmotion). But then he felt \(negativeEmotion). They were all out of \(noun)!"
