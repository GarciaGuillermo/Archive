...
brushTeeth + shower + chooseClothes + makeBed + eatcereal + contemplateLifeChoices
...
brushTeeth + shower + makeBed + chooseClothes

eatcereal + contemplateLifeChoices + brushTeeth + shower
// ^ things i like to do  
/*:
